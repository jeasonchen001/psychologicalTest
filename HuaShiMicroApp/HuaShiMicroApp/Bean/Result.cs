...
namespace HuaShiMicroApp
{
    public class Result: object
    {
        ...
        public void setEndTime()
        {
            ...
            usedTime = (int)period.TotalMilliseconds;
        ...
        {
            return String.Format("index: {0}, useTime: {1}, type: {2}, correct: {3}", this.index, this.usedTime, this.type, this.chooseIfCorrent);
        }
    }
}
